...
const pauseAllSongs = () => {
    Array.from(document.getElementsByClassName('playlistPlay')).forEach((element) => {
            element.classList.add("bxs-right-arrow");
...
Array.from(document.getElementsByClassName('playlistPlay')).forEach((element) => {
    element.addEventListener("click", (e) =>{
        index = e.target.id;
        pauseAllSongs();
        e.target.classList.remove("bxs-right-arrow");
...
Array.from(document.getElementsByClassName('songItemMenu')).forEach((element, i) => {
